...
public class WebMvcConfiguration extends WebMvcConfigurationSupport {
    ...
    public Docket docket1() {
        ApiInfo apiInfo = new ApiInfoBuilder()
                .title("星穹外卖项目接口文档")
                .version("2.0")
                .description("星穹外卖项目接口文档")
                .build();
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                .groupName("管理端接口")
                .apiInfo(apiInfo)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.star.controller.admin"))
    ...
    public Docket docket2() {
        ...
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.star.controller.user"))
                .paths(PathSelectors.any())
                .build();
        return docket;
    }
